...
def MailSender(filename,time):
    try:
        fromaddr = "deepikadhote12@gmail.com"
        toaddr = "gavaleanjali0@gmail.com"
        ...
        s.login(fromaddr,"qcfq ldey qyqd kwms")
...
def ProcessLog(log_dir = 'Demo'):
    ...
    separator = "-" * 80
    log_path = os.path.join(log_dir, "DemoLog%s.log" %(time.ctime()))
    f = open(log_path, 'w')
    f.write(separator + "\n")
...
def main():
    print("---- Demo World by Deepika Dhote-----")
